function x = UKFTransitionFcn(x, u)
...
dx = [(2/M)*(N_f*mu_f + N_r + mu_r);
      (1/J)*(-b_wheel*x(2) + Km*x(4) - R*N_f*mu_f);
      (1/J)*(-b_wheel*x(3) + Km*x(5) - R*N_r*mu_r);
      (1/Lm)*(-Km*x(2) - Rm*x(4) + u(1));
      (1/Lm)*(-Km*x(3) - Rm*x(5) + u(2))];
